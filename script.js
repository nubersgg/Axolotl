...
const floors = [
  ...
  [ //Floor 4
    ...
    //north
    { x: OriginX-220, y: OriginY-315, name: "Chorus Fruit", price: "0$", per: "32", active: false },
    { x: OriginX-202, y: OriginY-315, name: "Chorus Flower", price: "0$", per: "32", active: false },
    { x: OriginX-171, y: OriginY-349, name: "Cookie", price: "0$", per: "32", active: false },
    { x: OriginX-154, y: OriginY-349, name: "Cake", price: "0$", per: "32", active: false },
    { x: OriginX-137, y: OriginY-349, name: "Pumpkin Pie", price: "0$", per: "32", active: false },
    { x: OriginX-105, y: OriginY-364, name: "Bread", price: "0$", per: "32", active: false },
    { x: OriginX-90, y: OriginY-364, name: "Golden Carrot", price: "0$", per: "32", active: false },
    { x: OriginX-55, y: OriginY-384, name: "Bamboo", price: "0$", per: "32", active: false },
    { x: OriginX-38, y: OriginY-384, name: "Sugar Cane", price: "0$", per: "32", active: false },
    { x: OriginX-24, y: OriginY-384, name: "Cactus", price: "0$", per: "32", active: false },
    { x: OriginX-8, y: OriginY-384, name: "Carrot", price: "0$", per: "32", active: false },
    { x: OriginX+10, y: OriginY-384, name: "Potato", price: "0$", per: "32", active: false },
    { x: OriginX+26, y: OriginY-384, name: "Melon Slice", price: "0$", per: "32", active: false },
    { x: OriginX+40, y: OriginY-384, name: "Pumpkin", price: "0$", per: "32", active: false },
    { x: OriginX+57, y: OriginY-384, name: "Melon", price: "0$", per: "32", active: false },
    { x: OriginX+92, y: OriginY-364, name: "Glow Berries", price: "0$", per: "32", active: false },
    { x: OriginX+107, y: OriginY-364, name: "Sweet Berries", price: "0$", per: "32", active: false },
    { x: OriginX+139, y: OriginY-349, name: "Beetroot Seeds", price: "0$", per: "32", active: false },
    { x: OriginX+156, y: OriginY-349, name: "Melon Seeds", price: "0$", per: "32", active: false },
    { x: OriginX+173, y: OriginY-349, name: "Pumpkin Seeds", price: "0$", per: "32", active: false },
    { x: OriginX+204, y: OriginY-315, name: "Cocoa Beans", price: "0$", per: "32", active: false },
    { x: OriginX+222, y: OriginY-315, name: "Wheat Seeds", price: "0$", per: "32", active: false },
