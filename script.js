...
const floors = [
  ...
  [ //Floor 2
    ...
    { x: OriginX-154, y: OriginY-349, name: "Rooted Dirt", price: "0$", per: "32", active: true },
    { x: OriginX-137, y: OriginY-349, name: "Coarse Dirt", price: "0$", per: "32", active: true },
    ...
    { x: OriginX+384, y: OriginY+57, name: "Chiseled Stone", price: "0$", per: "32", active: true },
  ...
  [ //Floor 3
    ...
    { x: OriginX-349, y: OriginY-171, name: "Beehive", price: "0$", per: "32", active: true },
