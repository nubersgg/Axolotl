...
const floors = [
  [ //Floor 1
    ...
    // South
    { x: OriginX-222, y: OriginY+315, name: "Oak Leaves", price: "0$", per: "32", active: true },
    { x: OriginX-204, y: OriginY+315, name: "Spruce Leaves", price: "0$", per: "32", active: true },
    { x: OriginX-173, y: OriginY+349, name: "Birch Leaves", price: "0$", per: "32", active: true },
    { x: OriginX-156, y: OriginY+349, name: "Jungle Leaves", price: "0$", per: "32", active: true },
    { x: OriginX-139, y: OriginY+349, name: "Acacia Leaves", price: "0$", per: "32", active: true },
    { x: OriginX-106, y: OriginY+364, name: "Dark oak leaves", price: "0$", per: "32", active: true },
    { x: OriginX-92, y: OriginY+364, name: "Mangrove leaves", price: "0$", per: "32", active: true },
    { x: OriginX-57, y: OriginY+384, name: "Oak Log", price: "0$", per: "32", active: true },
    { x: OriginX-40, y: OriginY+384, name: "Spruce Log", price: "0$", per: "32", active: true },
    { x: OriginX-26, y: OriginY+384, name: "Birch Log", price: "0$", per: "32", active: true },
    { x: OriginX-10, y: OriginY+384, name: "Jungle Log", price: "0$", per: "32", active: true },
    { x: OriginX+8, y: OriginY+386, name: "Acacia Log", price: "0$", per: "32", active: true },
    { x: OriginX+24, y: OriginY+386, name: "Dark Oak Log", price: "0$", per: "32", active: true },
    { x: OriginX+38, y: OriginY+386, name: "Mangrove Log", price: "0$", per: "32", active: true },
    { x: OriginX+55, y: OriginY+386, name: "Cherry Log", price: "0$", per: "32", active: true },
    { x: OriginX+90, y: OriginY+368, name: "Cherry Leaves", price: "0$", per: "32", active: true },
    { x: OriginX+107, y: OriginY+368, name: "Flowering Azalea Leaves", price: "0$", per: "32", active: true },
    { x: OriginX+139, y: OriginY+351, name: "Azalea Leaves", price: "0$", per: "32", active: true },
    { x: OriginX+156, y: OriginY+351, name: "Azalea", price: "0$", per: "32", active: true },
    { x: OriginX+173, y: OriginY+351, name: "Flowering Azalea", price: "0$", per: "32", active: true },
    { x: OriginX+204, y: OriginY+317, name: "Bamboo Block", price: "0$", per: "32", active: true },
    { x: OriginX+222, y: OriginY+317, name: "Bamboo", price: "0$", per: "32", active: true },
