...
const floors = [
  [
    ...
    { x: 476, y: 105, name: "empty", price: "0", per: "32", active: true },
    { x: 492, y: 105, name: "empty", price: "0", per: "32", active: true },
    { x: 508, y: 105, name: "empty", price: "0", per: "32", active: true },
    { x: 523, y: 105, name: "empty", price: "0", per: "32", active: true },
    { x: 555, y: 122, name: "empty", price: "0", per: "32", active: true },
    { x: 570, y: 122, name: "empty", price: "0", per: "32", active: true },
    { x: 600, y: 137, name: "empty", price: "0", per: "32", active: true },
    { x: 615, y: 137, name: "empty", price: "0", per: "32", active: true },
    { x: 630, y: 137, name: "empty", price: "0", per: "32", active: true },
    { x: 662, y: 165, name: "empty", price: "0", per: "32", active: true },
    { x: 677, y: 165, name: "empty", price: "0", per: "32", active: true },
  ],
