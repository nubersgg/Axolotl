...
const floors = [
  [ //Floor 1
    ...
    { x: OriginX-349, y: OriginY+173, name: "Mushroom Stem", price: "3000$", per: "32", active: true },
    { x: OriginX-315, y: OriginY+204, name: "Muddy Mangrove Roots", price: "0$", per: "32", active: true },
    { x: OriginX-315, y: OriginY+222, name: "Mangrove Roots", price: "0$", per: "32", active: true },
  ],
