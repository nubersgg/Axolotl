...
const floors = [
  [ //Floor 1
    ...
    { x: OriginX-106, y: OriginY+364, name: "Flowering Azalea Leaves", price: "0$", per: "32", active: true },
    ...
    { x: OriginX+8, y: OriginY+386, name: "Jungle Log", price: "0$", per: "32", active: true },
    { x: OriginX+24, y: OriginY+386, name: "Birch Log", price: "0$", per: "32", active: true },
    { x: OriginX+38, y: OriginY+386, name: "Spruce Log", price: "0$", per: "32", active: true },
    { x: OriginX+55, y: OriginY+386, name: "Oak Log", price: "0$", per: "32", active: true },
    { x: OriginX+90, y: OriginY+368, name: "Mangrove leaves", price: "0$", per: "32", active: true },
    { x: OriginX+107, y: OriginY+368, name: "Dark oak leaves", price: "0$", per: "32", active: true },
    { x: OriginX+139, y: OriginY+351, name: "Acacia Leaves", price: "0$", per: "32", active: true },
    { x: OriginX+156, y: OriginY+351, name: "Jungle Leaves", price: "0$", per: "32", active: true },
    { x: OriginX+173, y: OriginY+351, name: "Birch Leaves", price: "0$", per: "32", active: true },
    { x: OriginX+204, y: OriginY+317, name: "Spruce Leaves", price: "0$", per: "32", active: true },
    { x: OriginX+222, y: OriginY+317, name: "Oak Leaves", price: "0$", per: "32", active: true },
  ...
  [ //Floor 2
    ...
    //north
    { x: OriginX-220, y: OriginY-315, name: "Stone", price: "0$", per: "32", active: true },
    { x: OriginX-202, y: OriginY-315, name: "Stone Bricks", price: "0$", per: "32", active: true },
    { x: OriginX-171, y: OriginY-349, name: "Mossy Stone Bricks", price: "0$", per: "32", active: true },
    { x: OriginX-154, y: OriginY-349, name: "Deepslate Bricks", price: "0$", per: "32", active: true },
    { x: OriginX-137, y: OriginY-349, name: "Deepslate Tiles", price: "0$", per: "32", active: true },
    { x: OriginX-105, y: OriginY-364, name: "Tuff Bricks", price: "0$", per: "32", active: true },
    { x: OriginX-90, y: OriginY-364, name: "Mud Bricks", price: "0$", per: "32", active: true },
    { x: OriginX-55, y: OriginY-384, name: "Bricks", price: "0$", per: "32", active: true },
    { x: OriginX-38, y: OriginY-384, name: "Smooth Stone", price: "0$", per: "32", active: true },
    { x: OriginX-24, y: OriginY-384, name: "Polished Granite", price: "0$", per: "32", active: true },
    { x: OriginX-8, y: OriginY-384, name: "Polished Diorite", price: "0$", per: "32", active: true },
    { x: OriginX+10, y: OriginY-384, name: "Polished Andesite", price: "0$", per: "32", active: true },
    { x: OriginX+26, y: OriginY-384, name: "Polished Deepslate", price: "0$", per: "32", active: true },
    { x: OriginX+40, y: OriginY-384, name: "Polished Tuff", price: "0$", per: "32", active: true },
    { x: OriginX+57, y: OriginY-384, name: "Chiseled Stone Bricks", price: "0$", per: "32", active: true },
    { x: OriginX+92, y: OriginY-364, name: "Chiseled Deepslate", price: "0$", per: "32", active: true },
    { x: OriginX+107, y: OriginY-364, name: "Chiseled Tuff", price: "0$", per: "32", active: true },
    { x: OriginX+139, y: OriginY-349, name: "Chiseled Tuff Bricks", price: "0$", per: "32", active: true },
    { x: OriginX+156, y: OriginY-349, name: "Chiseled Sandstone", price: "0$", per: "32", active: true },
    { x: OriginX+173, y: OriginY-349, name: "Chiseled Red Sandstone", price: "0$", per: "32", active: true },
    { x: OriginX+204, y: OriginY-315, name: "Calcite", price: "0$", per: "32", active: true },
    { x: OriginX+222, y: OriginY-315, name: "Smooth Basalt", price: "0$", per: "32", active: true },

    // East
    { x: OriginX+315, y: OriginY-220, name: "Grass Block", price: "0$", per: "32", active: true },
    { x: OriginX+315, y: OriginY-202, name: "Podzol", price: "0$", per: "32", active: true },
    { x: OriginX+349, y: OriginY-171, name: "Mycelium", price: "0$", per: "32", active: true },
    { x: OriginX+349, y: OriginY-154, name: "Coarse Dirt", price: "0$", per: "32", active: true },
    { x: OriginX+349, y: OriginY-137, name: "Dirt", price: "0$", per: "32", active: true },
    { x: OriginX+364, y: OriginY-105, name: "Moss Block", price: "0$", per: "32", active: true },
    { x: OriginX+364, y: OriginY-90, name: "Mud", price: "0$", per: "32", active: true },
    { x: OriginX+384, y: OriginY-55, name: "Sand", price: "0$", per: "32", active: true },
    { x: OriginX+384, y: OriginY-38, name: "Sandstone", price: "0$", per: "32", active: true },
    { x: OriginX+384, y: OriginY-24, name: "Red Sand", price: "0$", per: "32", active: true },
    { x: OriginX+384, y: OriginY-8, name: "Red Sandstone", price: "0$", per: "32", active: true },
    { x: OriginX+384, y: OriginY+10, name: "Gravel", price: "0$", per: "32", active: true },
    { x: OriginX+384, y: OriginY+26, name: "Clay", price: "0$", per: "32", active: true },
    { x: OriginX+384, y: OriginY+40, name: "Mossy Cobblestone", price: "0$", per: "32", active: true },
    { x: OriginX+384, y: OriginY+57, name: "Cobblestone", price: "0$", per: "32", active: true },
    { x: OriginX+364, y: OriginY+92, name: "Deepslate", price: "0$", per: "32", active: true },
    { x: OriginX+364, y: OriginY+107, name: "Cobbled Deepslate", price: "0$", per: "32", active: true },
    { x: OriginX+349, y: OriginY+139, name: "Granite", price: "0$", per: "32", active: true },
    { x: OriginX+349, y: OriginY+156, name: "Diorite", price: "0$", per: "32", active: true },
    { x: OriginX+349, y: OriginY+173, name: "Andesite", price: "0$", per: "32", active: true },
    { x: OriginX+315, y: OriginY+204, name: "Dripstone Block", price: "0$", per: "32", active: true },
    { x: OriginX+315, y: OriginY+222, name: "Tuff", price: "0$", per: "32", active: true },
    ...
    { x: OriginX-156, y: OriginY+349, name: "", price: "0$", per: "32", active: false },
    { x: OriginX-139, y: OriginY+349, name: "", price: "0$", per: "32", active: false },
    { x: OriginX-106, y: OriginY+364, name: "Pink Terracotta", price: "0$", per: "32", active: false },
    { x: OriginX-92, y: OriginY+364, name: "Magenta Terracotta", price: "0$", per: "32", active: true },
    { x: OriginX-57, y: OriginY+384, name: "Purple Terracotta", price: "0$", per: "32", active: true },
    { x: OriginX-40, y: OriginY+384, name: "Blue Terracotta", price: "0$", per: "32", active: true },
